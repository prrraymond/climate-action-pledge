        ...
        <div className="mt-24 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-white/5 rounded-lg">
              <div className="text-emerald-400 text-4xl font-bold">12K+</div>
              <div className="text-white/80">Active Pledges</div>
            </div>
            <div className="p-6 bg-white/5 rounded-lg">
              <div className="text-emerald-400 text-4xl font-bold">245</div>
              <div className="text-white/80">Tons CO₂e Saved</div>
            </div>
            <div className="p-6 bg-white/5 rounded-lg">
              <div className="text-emerald-400 text-4xl font-bold">6</div>
